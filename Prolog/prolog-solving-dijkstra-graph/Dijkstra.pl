...
menorCaminhoDeAateB_Rec(V_destino, VerticeFechadoAtualmente, ListaDeVerticesFechados, ListaIterativa, ListaDeVerticesMenorCaminho):-
    VerticeFechadoAtualmente == V_destino ->
        ...
        (
            %exclui-se os vertices ja fechados
            caminhoMaisCurtoEntreVariosCaminhosExcluindoLista( ListaDeVerticesFechados, ListaIterativa, MenorCaminhoDaIteracao)
            ...
            ,menorCaminhoDeAateB_Rec(V_destino, VerticeFechadoNaIteracao, NovaListaDeVerticesFechados, ListaDaIteracaoDesambiguada, ListaDeVerticesMenorCaminho)
        ).
